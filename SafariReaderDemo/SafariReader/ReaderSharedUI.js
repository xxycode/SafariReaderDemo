...
function smoothScroll(e, t, n, i) {
    ...
    if (c < Math.abs(t) && (n = n * c / Math.abs(t)), smoothScrollingAnimator) {
        ...
        m = c * c,
        u = (a - l * m) / (1 - m);
        return abortSmoothScroll(),
        smoothScrollingAnimator = new AppleAnimator(s, r, i),
        smoothScrollingAnimation = new AppleAnimation(u, l, o),
        smoothScrollingAnimator.addAnimation(smoothScrollingAnimation),
        void smoothScrollingAnimator.start(d)
    }
    smoothScrollingAnimator = new AppleAnimator(n, r, i),
    smoothScrollingAnimation = new AppleAnimation(a, l, o),
    smoothScrollingAnimator.addAnimation(smoothScrollingAnimation),
...
function articleScrolled() { ! scrollEventIsSmoothScroll && smoothScrollingAnimator && abortSmoothScroll(),
...
function getArticleScrollPosition() {
    ...
    t = e.length;
    if (!t) return scrollInfo.pageIndex = 0,
    scrollInfo;
...
function stopExtendingElementBeyondTextColumn(e) {
    ...
    e.style && (e.style.removeProperty("width"), e.style.removeProperty("-webkit-margin-start"))
}
function leadingMarginAndPaddingAppliedToElementFromAncestors(e) {
    ...
    for (; n && !n.classList.contains("page");) {
        ...
        t += parseFloat(e["-webkit-padding-start"]) + parseFloat(e["-webkit-margin-start"]),
        n = n.parentElement
    }
    return t
}
function extendElementBeyondTextColumn(e, t, n) {
    ...
    e.style && (e.style.setProperty("width", t + "px"), e.style.setProperty("-webkit-margin-start", (n - t) / 2 - leadingMarginAndPaddingAppliedToElementFromAncestors(e) + "px"))
}
...
function addIncomingPagePlaceholder(e) {
    ...
    t.className = "page",
    t.id = "incoming-page-placeholder";
    let n = document.createElement("div");
    n.id = "incoming-page-corner";
    let i = document.createElement("div");
    i.id = "incoming-page-text",
    i.innerText = getLocalizedString(e ? "Loading Next Page\u2026": "Connect to the internet to view remaining pages."),
    n.appendChild(i),
    t.appendChild(n),
...
function nextPageLoadComplete() {
    ...
    // t && (ReaderJS.createPageFromNode(t), ReaderJS.routeToArticle = e.routeToArticleNode()),
    // nextPageContainer().removeAttribute("src"),
    // ReaderJSController.clearNextPageArticleFinder(),
    // ReaderJS.canLoadNextPage() ? ReaderJS.setNextPageURL(e.nextPageURL()) : ReaderJS.setCachedNextPageURL(e.nextPageURL()),
    // updatePageNumbers(),
    ...
    value(e) {
        return new Proxy(this, {
            get: (t, n) =>(...i) =>{
                ...
                let r = () =>{
                    o[debounceTimeoutSymbol] = void 0,
                    o.apply(t, i)
                };
...
AppleAnimator = function(e, t, n) {
    ...
    this.animate = function() {
        ...
        r = (new Date).getTime(),
        a = i.duration;
        t = e(r - i.startTime, 0, a),
        r = t / a,
        n = .5 - .5 * Math.cos(Math.PI * r),
        o = t >= a;
        let l = i.animations,
        s = l.length,
        d = i._firstTime;
...
AppleAnimation.prototype = {
    doFrame: function(e, t, n, i, o) {
        let r;
        r = i ? this.to: this.from + (this.to - this.from) * t,
        this.now = r,
        this.ease = t,
        this.progress = o,
        this.callback(e, r, n, i)
    }
};
...
ContentAwareScroller.prototype = {
    ...
    scroll: function(e) {
        ...
        } else if (e === ContentAwareNavigationDirection.Up) if (o === articleTitleElement()) {
...
ReaderAppearanceController.prototype = {
    initialize: function() {
        ...
        this._isOLEDDisplay() && document.body.classList.add("oled")
    },
    applyConfiguration: function(e) {
        if (this._tryApplyStaticConfiguration()) return void this.layOutContent();
        let t = this._locale();
        this.setLocale(t);
        for (let n of[e.fontFamilyNameForLanguageTag[t], e.defaultFontFamilyNameForLanguage[t], "System"]) if (n && this.setFontFamily(n)) break;
    ...
    setFontFamily: function(e) {
        ...
        return "function" == typeof ReaderJSController.makeFontAvailableIfNecessary && ReaderJSController.makeFontAvailableIfNecessary(e),
    ...
    _layOutVideos: function() {
        ...
        let n,
        i,
        o = ReaderAppearanceJS.canLayOutContentMaintainingAspectRatioBeyondTextColumn();
        for (let r of document.getElementById("article").querySelectorAll("iframe")) {
            ...
            if (a ? l = r.parentElement: (l = document.createElement("div"), l.className = "iframe-wrapper", r.nextSibling ? r.parentNode.insertBefore(l, r.nextSibling) : r.parentNode.appendChild(l), l.appendChild(r)), n || (n = Math.min(MaximumWidthOfImageOrVideoExtendingBeyondTextContainer, this._widthAvailableForLayout())), i || (i = this._textColumnWidthInPoints()), o && n > i) {
                l.style.height = n / t + "px",
                extendElementBeyondTextColumn(l, n, i),
                r.style.height = "100%";
                let e = this.usesPaperAppearance() ? 2 : 0;
                r.style.width = n - e + "px"
            } else stopExtendingElementBeyondTextColumn(l),
            l.style.width = "100%",
            l.style.height = i / t + "px"
        }
    },
...
ReaderController.prototype = {
    ...
    stopLoadingNextPage: function() {
        ...
        this.isLoadingNextPage() && (this.setLoadingNextPage(!1), this.loadingNextPageManuallyStopped = !0)
    },
    ...
    loadArticle: function(e = LoadingMode.Normal) {
        ...
        if (t.article || t.articleNode(!0), !t.article) return this.setOriginalURL(t.contentDocument.baseURI),
        ...
        if (document.title = r.title, this.setOriginalURL(r.baseURI), this.readerOperationMode != ReaderOperationMode.ArchiveViewing) {
            if (this._isJavaScriptEnabled()) o = t.nextPageURL(),
            this.setNextPageURL(o);
            else {
            ...
            o || (t.adoptableMultiPageContentElements().forEach(this.createPageFromNode, this), updatePageNumbers()),
            this.isLoadingNextPage() || this.doneLoadingAllPages(),
            e === LoadingMode.Reload && setTimeout((function() {
    ...
    reloadArticlePreservingScrollPositionIfArticleNodeContentHasChanged: function() {
        ...
        n = 30;
        for (const e of document.querySelectorAll("audio, video")) if (mediaElementIsPlaying(e)) return;
    ...
    _adoptableArticlesAreUserVisiblyEquivalent: function(e, t) {
        function n(e, t) {
            ...
            case Node.ELEMENT_NODE:
                ...
                let o = t.attributes;
                for (let e of n) if (e.name !== i && e.value !== o[e.name].value) return ! 1;
                break;
            case Node.TEXT_NODE:
    ...
    _reloadArticleAndPreserveScrollPosition: function(e) {
        ...
        [i, o] = ReadingPositionStabilizerJS.uniqueIDAndScrollRatioOfElementPinnedToTop();
        ...
        if (this.reinitialize(), e || (document.scrollingElement.scrollTop = 0), this.loadArticle(LoadingMode.Reload), e) {
            let e;
            i && (e = ReadingPositionStabilizerJS.tryToScrollToUniqueIDAndRatio(i, o)),
            e || scrollTo(t, n)
        }
    ...
    createPageFromNode: function(e) {
        ...
        let n = document.createElement("div");
        n.className = "page",
        this.articleIsLTR || n.classList.add("rtl");
        let i = document.createElement("div");
        i.className = "page-number",
        n.appendChild(i);
        ...
        if (r.setAttribute(a, t.titleUniqueID()), n.appendChild(r), this.displaySubhead) {
            ...
            e.setAttribute(a, t.subheadUniqueID()),
            n.appendChild(e)
        }
        ...
        document.getElementById("article").insertBefore(n, incomingPagePlaceholder()),
        ReaderJS._isJavaScriptEnabled() && ReaderJSController.replaceSimpleTweetsWithRichTweets(this.optionsForTweetCreation()),
        ReaderAppearanceJS.layOutContent(ShouldRestoreReadingPosition.No),
        updatePageNumbers(),
        restoreInitialArticleScrollPositionIfPossible();
        for (let e of n.querySelectorAll("img")) e.onload = function(e) {
            let t = e.target;
            ReaderAppearanceJS.setImageOrVideoShouldLayOutBeyondTextColumnIfAppropriate(t, ReaderAppearanceJS.canLayOutContentMaintainingAspectRatioBeyondTextColumn()),
            t.onload = null
        };
    ...
    optionsForTweetCreation: function() {
        ...
        return t && t.tweetTheme && (e.theme = t.tweetTheme),
        e
    },
    ...
    sanitizedFullArticleFrame: function() {
        ...
        return r.innerText = document.title,
    ...
    sanitizedFullArticle: function() {
        ...
        ReaderAppearanceJS.currentFontUsesSystemFont() && e.classList.add("system"),
    ...
    readerWillBecomeVisible: function() {
        ...
        this._readerIsActive && requestAnimationFrame((function() {
            ReadingPositionStabilizerJS.applyScrollPositionFromOriginalPage()
        }))
    },
    readerWillEnterBackground: function() { (ReaderJS.isLoadingNextPage() || ReaderJS.loadingNextPageManuallyStopped) && this.pauseLoadingNextPage();
...
ReadingPositionStabilizer.prototype = {
    initialize: function() {
        ...
        const e = 250;
        this._checkForUpdatedContentSoon = this.debounce(e)._checkForUpdatedContentNow,
    ...
    setTrackPosition: function(e) {
        ...
        const t = 250;
        this._debouncedDidScroll || (this._debouncedDidScroll = this.debounce(t)._didScroll),
        e ? window.addEventListener("scroll", this._debouncedDidScroll, {
            capture: !1,
            passive: !0
    ...
    _updatePosition: function(e = !0) {
        ...
        this.elementTouchingTopOfViewportOffsetFromTopOfElementRatio = n.height > 0 ? n.top / n.height: 0,
        this._originalPageScrollSyncAndContentRefreshIsAllowed() && ReaderJS.readerIsForeground() && (this._pushScrollPositionToOriginalPage(), e && this._checkForUpdatedContentSoon())
    },
